	...
	<body>
			...
			<!-- 로그인 된 페이지 -->
				<div class="log_box2">
					...
					<span></span>
						...
						<p><span><a href="#"><%=user_name %>님</a></span><span><a href="#">내정보</a></span></p>
						<p><span><a href="#">메일</a></span><span><a href="#">쪽지</a></span><span class="btn1"><a href="modify.jsp">회원정보수정</a></span><span class="btn"><a href="logout.jsp">로그아웃</a></span></p>
		...
		%>
			<!-- 로그인 안 된 페이지 -->
				...
				<div id="login_b">
					<a href="login.html"><span>NAVER 로그인</span></a>
				</div>
				<div id="bottom">
					<a href="#">아이디</a>
					<a href="#">비밀번호</a>
